...
| Financial Reports | `/companies/:companyId/accounting/reports/trial-balance`, `/general-ledger`, `/profit-loss`, `/balance-sheet` plus `/export` variants | Read-only posted-voucher reporting and CSV export. |
...
| Financial Reports | `/accounting/reports/trial-balance`, `/general-ledger`, `/profit-loss`, `/balance-sheet` | Admin, accountant. |
