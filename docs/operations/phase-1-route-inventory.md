...
| CRM & Property Desk       | `/companies/:companyId/customers`, `/customers/:customerId/profile`, `/leads`, `/bookings`, `/sale-contracts`, `/installment-schedules`, `/collections`                                                           | Admin and sales operational flows. Customer profile responses consolidate read-only records; collection detail responses include read-only receipt context where linked records exist. |
...
| CRM & Property Desk       | `/crm-property-desk/customers`, `/customers/[customerId]`, `/leads`, `/bookings`, `/sale-contracts`, `/installment-schedules`, `/collections`, `/collections/[collectionId]/receipt` | Admin, sales.                                             |
...
| `/crm-property-desk/customers/[customerId]`             | no         | no             |
| `/crm-property-desk/bookings`                           | yes        | no             |
| `/crm-property-desk/collections`                        | yes        | no             |
| `/crm-property-desk/collections/[collectionId]/receipt` | no         | yes            |
| `/hr/employees`                                         | yes        | no             |
