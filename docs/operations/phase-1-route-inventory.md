...
| CRM & Property Desk       | `/companies/:companyId/customers`, `/leads`, `/bookings`, `/sale-contracts`, `/installment-schedules`, `/collections`                                                                                             | Admin and sales operational flows. Collection detail responses include read-only receipt context where linked records exist. |
...
| CRM & Property Desk       | `/crm-property-desk/customers`, `/leads`, `/bookings`, `/sale-contracts`, `/installment-schedules`, `/collections`, `/collections/[collectionId]/receipt`  | Admin, sales.                                             |
